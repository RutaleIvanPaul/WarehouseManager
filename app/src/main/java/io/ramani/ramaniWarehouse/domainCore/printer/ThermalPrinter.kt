        ...
        while (row < height) {
            ...
            for (col in 0 until width) {
                ...
                for (rowOffset in 0..7) {
                    ...
                    pixelSlice[1] = if (pixel2Row >= bitmap.height) Color.WHITE else bitmap.getPixel(col, pixel2Row)
                    pixelSlice[2] = if (pixel3Row >= bitmap.height) Color.WHITE else bitmap.getPixel(col, pixel3Row)
