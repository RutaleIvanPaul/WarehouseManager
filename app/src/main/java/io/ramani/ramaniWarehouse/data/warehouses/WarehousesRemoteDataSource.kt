...
class WarehousesRemoteDataSource(
    ...
    private val invoiceRemoteModelMapper: UniModelMapper<InvoiceRemoteModel, InvoiceModel>
    ...
    override fun getInvoices(getWarehousesRequestModel: GetWarehousesRequestModel): Single<PagedList<InvoiceModel>> =
        callSingle(
            ...
            val meta = PaginationMeta.Builder()
                ...
                .build()
            Single.just(
                PagedList.Builder<InvoiceModel>()
                    .data(data?.mapFromWith(invoiceRemoteModelMapper) ?: listOf())
                    .paginationMeta(meta)
                    .build()
            )
        }
