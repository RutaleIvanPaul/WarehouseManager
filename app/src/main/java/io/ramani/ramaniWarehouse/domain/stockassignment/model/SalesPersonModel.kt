...
data class SalesPersonModel(
    ...
    class Builder:IBuilder<SalesPersonModel>{
        ...
        override fun build(): SalesPersonModel  =
            SalesPersonModel(
    ...
    companion object CREATOR : Parcelable.Creator<SalesPersonModel> {
        override fun createFromParcel(parcel: Parcel): SalesPersonModel {
            return SalesPersonModel(parcel)
        }

        override fun newArray(size: Int): Array<SalesPersonModel?> {
